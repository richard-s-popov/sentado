...
jQuery(document).ready(function () {
    // show forms in modal window

    jQuery('.i18n-ru .slide .bttn-239 a, .i18n-ru .row-4 .bttn a').click(function(){
        jQuery('.row-5')
    ...
    jQuery('.i18n-en .slide .bttn-239 a, .i18n-en .row-4 .bttn a').click(function(){
        jQuery('.row-5')
            .addClass('modal hide fade')
            .attr('tabindex', '1');
